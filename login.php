...
<div class="login">
	...
	<form action = "login_code.php" method= "POST">
		<input type="email" name="email" class="user active" value="Email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}"/>
		<input type="password" name="pass" class="lock active" value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}"/>
	...
	<div class="login-bottom">
	 ...
	 <div class="social-icons">
		...
		<div class="reg-bwn"><a href="register.html">REGISTER</a></div>
	</div>
  </div>
</div>
